    ...
    def run(self, player_score: list[int]):
        ...
        while True:
            ...
            for ent in self.entity_list:
                ...
                if ent.name == 'Player1':
                    self.level_text(text_size=14, text= f'Player1 - Health:{ent.health} | Score: {ent.score}', C_GREEN, text_pos=(10, 25))
                if ent.name == 'Player2':
                    self.level_text(text_size=14, text= f'Player1 - Health:{ent.health} | Score: {ent.score}', C_CYAN, text_pos=(10, 45))
